...
//        "&currency=USD&hl=en&api_key=2e6ff4c799c82804bf56ffd1e046a88d9727e21c78a087394d81c43e5cf7e36b";
        ...
        if ("roundtrip".equalsIgnoreCase(tripType.trim())) {
            ...
            apiUrl = "https://serpapi.com/search.json?engine=google_flights&departure_id=" + from +
                    ...
                    "&outbound_date=" + departure +
                    "&return_date=" + returnDate +
                    "&currency=USD&hl=en&api_key=a86e162b04ae4f9880ab0e9716c6336ae410fdddd822aa078139f37f5af071f6";
        } else {
            // One-way flight search
            apiUrl = "https://serpapi.com/search?engine=google_flights&departure_id=" + from +
                    "&arrival_id=" + to +
                    "&outbound_date=" + departure +
                    "&type=2&currency=INR&hl=en&api_key=a86e162b04ae4f9880ab0e9716c6336ae410fdddd822aa078139f37f5af071f6";
        }
...
//        dispatcher.forward(request, response);
        String jspPage = "roundtrip".equalsIgnoreCase(tripType.trim()) ? "displayFlightUser/displayFlights.jsp" : "displayFlightUser/displayOneWay.jsp";
