...
public class ModifyFlightServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("modifyFlight.jsp").forward(request, response);
            return;
        }
        ...
        if (isModified) {
            ...
            request.getRequestDispatcher("modifyFlightError.jsp").forward(request, response);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("modifyFlight.jsp");
    }
}
